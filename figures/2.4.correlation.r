...
################################ cis
    ...
    p <-ggplot() +
        ...
        #axis
        scale_y_continuous(name = "Count (pos + neg)",sec.axis = sec_axis(~ . / scale_factor, name = "Percentage (per)")) +
    ...
    ggsave(filename="./2.4.correlation_statistic_cis.pdf",plot=p,device="pdf",width=10,height=6,units="in",dpi=300)
...
################################ trans
    ...
    ggsave(filename="./2.4.correlation_statistic_trans.pdf",plot=p,device="pdf",width=10,height=6,units="in",dpi=300)
...
################################ cis-100bp,1000bp,10000bp,100000bp
    ...
    for(threshold in thresholds){
        ...
        ggsave(filename=paste0("./2.4.correlation_statistic_cis_",threshold,"bp.pdf"),plot=p,device="pdf",width=10,height=6,units="in",dpi=300)        
    }
###################################################################################